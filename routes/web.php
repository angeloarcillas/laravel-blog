...
// [ VOTE ]
Route::post('questions/{question}/vote', QuestionVoteController::class)->name('questions.vote');
Route::post('answers/{answer}/vote', AnswerVoteController::class)->name('questions.vote');